...
Public Class ctrPrintOrder
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bagshop.ctrPrintOrder.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedctrPrintOrder
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctrPrintOrder = New ctrPrintOrder()
        rpt.Site = Me.Site
        Return rpt
    End Function
