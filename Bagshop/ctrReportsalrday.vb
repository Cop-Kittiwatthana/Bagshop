...
Public Class ctrReportsalrday
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bagshop.ctrReportsalrday.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedctrReportsalrday
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctrReportsalrday = New ctrReportsalrday()
        rpt.Site = Me.Site
        Return rpt
    End Function
