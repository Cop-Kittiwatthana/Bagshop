...
Public Class ctrCategory11
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bagshop.ctrCategory11.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedctrCategory11
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctrCategory11 = New ctrCategory11()
        rpt.Site = Me.Site
        Return rpt
    End Function
